...
export const CloseIcon = ({size}: sizeProp) => {
    return (
...
export const BurgerMenuIcon = ({size}: sizeProp) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={size ? `${size}` : "w-6 h-6"}>
...
export const NotificationIcon = ({size}: sizeProp) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={size ? `${size}` : "w-6 h-6"}>
...
export const ToolsIcon = ({size}: sizeProp) => {
    return (
...
export const DocumentIcon = ({size}: sizeProp) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={size ? `${size}` : "w-6 h-6 text-inherit mr-3 md:mr-0"}>
...
export const CustomerIcon = ({size}: sizeProp) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={size ? `${size}` : "w-6 h-6 text-inherit mr-3 md:mr-0"}>
...
export const GearIcon = ({size}: sizeProp) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={size ? `${size}` : "w-6 h-6 text-inherit mr-3 md:mr-0"}>
...
export const EditIcon = ({size}: sizeProp) => {
    return (
        <span>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={size ? `${size}` : 'w-6 h-6'}>
...
export const DeleteIcon = ({size}: sizeProp) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={size ? `${size}` : 'w-6 h-6'}>
...
export const WarningIcon = ({size}: sizeProp) => {
    return (
...
export const BackArrowIcon = ({size}: sizeProp) => {
    return (
...
export const SearchIcon = ({size}: sizeProp) => {
    return (
...
export const DownArrowIcon = ({size}: sizeProp) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={size ? `${size}` : "w-6 h-4 pl-2 ml-auto"}>
            <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
        </svg>
    )
}

export const FileUploadIcon = ({size}: sizeProp) => {
    return (
...
export const FileIcon = ({size}: sizeProp) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={size ? `${size}` : "w-6 h-6"}>
...
export const QRcodeIcon = ({size}: sizeProp) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={size ? `${size}` : "w-6 h-6"}>
...
export const QRscanner = ({size}: sizeProp) => {
    return (
...
export const TemplateFolder = ({size}: sizeProp) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={size ? `${size}` : "w-6 h-6"}>
...
export const MachineOrder = ({size}: sizeProp) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={size ? `${size}` : "w-6 h-6"}>
